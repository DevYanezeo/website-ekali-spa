              ...
              <div className="space-y-6 mt-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@ekalisolutions.com" className="text-primary hover:text-primary-hover">
                ...
                <div className="flex items-start space-x-4">
                  <div className="rounded-md bg-secondary/10 p-3 flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-secondary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-foreground font-medium">Teléfono</h3>
                    <a href="tel:+56912345678" className="text-secondary hover:text-secondary-hover">
                      +56 9 1234 5678
                    </a>
                  </div>
                </div>
